...
export namespace analyzer {
	...
	export type Exports = {
		...
		check: (path: string, content: string) => Diagnostic[];
	};
...
export namespace analyzer.$ {
	export const Position = new $wcm.RecordType<Position>([
		['line', $wcm.u32],
		['character', $wcm.u32],
	]);
	...
	export const Location = new $wcm.RecordType<Location>([
		['uri', $wcm.wstring],
		['range', Range],
	]);
	export const DiagnosticRelatedInformation = new $wcm.RecordType<DiagnosticRelatedInformation>([
		['location', Location],
		['message', $wcm.wstring],
	]);
	...
	export const MemberKind = new $wcm.VariantType<MemberKind, MemberKind._tt, MemberKind._vt>([['parameter', ParameterInfo], ['property', new $wcm.OptionType<string>($wcm.wstring)], ['relationship', new $wcm.OptionType<string>($wcm.wstring)], ['foreignKey', undefined], ['index', undefined], ['projection', undefined], ['trigger', undefined], ['xData', undefined], ['storage', undefined], ['query', undefined], ['method', MethodInfo], ['classMethod', MethodInfo], ['clientMethod', MethodInfo]], analyzer.MemberKind._ctor);
	...
	export const RoutineInfo = new $wcm.VariantType<RoutineInfo, RoutineInfo._tt, RoutineInfo._vt>([['INC', new $wcm.ListType<analyzer.MacroInfo>(MacroInfo)], ['INT', new $wcm.ListType<analyzer.SubroutineInfo>(SubroutineInfo)], ['MAC', new $wcm.ListType<analyzer.SubroutineInfo>(SubroutineInfo)]], analyzer.RoutineInfo._ctor);
	export const ParseErr = new $wcm.RecordType<ParseErr>([
		['range', Range],
		['message', $wcm.wstring],
	]);
	export const AnalysisErr = new $wcm.VariantType<AnalysisErr, AnalysisErr._tt, AnalysisErr._vt>([['P', ParseErr]], analyzer.AnalysisErr._ctor);
	...
	export const Diagnostic = new $wcm.RecordType<Diagnostic>([
		['message', $wcm.wstring],
		['range', Range],
		['relatedInformation', new $wcm.ListType<analyzer.DiagnosticRelatedInformation>(DiagnosticRelatedInformation)],
	]);
	export namespace exports {
		export const analyzeCls = new $wcm.FunctionType<analyzer.Exports['analyzeCls']>('analyze-cls', [
			['path', $wcm.wstring],
			['src', $wcm.wstring],
		], new $wcm.ResultType<analyzer.ClassInfo, analyzer.AnalysisErr>(ClassInfo, AnalysisErr, analyzer.AnalysisErr.Error_));
		export const analyzeRtn = new $wcm.FunctionType<analyzer.Exports['analyzeRtn']>('analyze-rtn', [
			['path', $wcm.wstring],
			['src', $wcm.wstring],
		], new $wcm.ResultType<analyzer.RoutineInfo, analyzer.AnalysisErr>(RoutineInfo, AnalysisErr, analyzer.AnalysisErr.Error_));
		export const completeClass = new $wcm.FunctionType<analyzer.Exports['completeClass']>('complete-class', [
			['path', $wcm.wstring],
			['prefix', $wcm.wstring],
		], new $wcm.ResultType<analyzer.Completion, analyzer.AnalysisErr>(Completion, AnalysisErr, analyzer.AnalysisErr.Error_));
		export const completeMethod = new $wcm.FunctionType<analyzer.Exports['completeMethod']>('complete-method', [
			['path', $wcm.wstring],
			['prefix', $wcm.wstring],
		], new $wcm.ResultType<analyzer.Completion, analyzer.AnalysisErr>(Completion, AnalysisErr, analyzer.AnalysisErr.Error_));
		export const check = new $wcm.FunctionType<analyzer.Exports['check']>('check', [
			['path', $wcm.wstring],
			['content', $wcm.wstring],
		], new $wcm.ListType<analyzer.Diagnostic>(Diagnostic));
	}
}
export namespace analyzer._ {
	...
	export type Exports = {
		'analyze-cls': (path_ptr: i32, path_len: i32, src_ptr: i32, src_len: i32, result: ptr<result<ClassInfo, AnalysisErr>>) => void;
		'analyze-rtn': (path_ptr: i32, path_len: i32, src_ptr: i32, src_len: i32, result: ptr<result<RoutineInfo, AnalysisErr>>) => void;
		'complete-class': (path_ptr: i32, path_len: i32, prefix_ptr: i32, prefix_len: i32, result: ptr<result<Completion, AnalysisErr>>) => void;
		'complete-method': (path_ptr: i32, path_len: i32, prefix_ptr: i32, prefix_len: i32, result: ptr<result<Completion, AnalysisErr>>) => void;
		'check': (path_ptr: i32, path_len: i32, content_ptr: i32, content_len: i32, result: ptr<Diagnostic[]>) => void;
	};
