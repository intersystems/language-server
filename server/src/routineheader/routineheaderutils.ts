...
// attribute indexes for parsing routine headers
export const cos_attribute_label = 0x03;
export const cos_attribute_delimiter = 0x0D;
export const cos_attribute_name = 0x16;
export const cos_attribute_number = 0x17;
export const cos_attribute_routine = 0x19;
export const cos_attribute_command = 0x20;
